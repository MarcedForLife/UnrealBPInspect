...
//! to another. This module is the single home for those operations: it spells
//! the scope/lhs policy out as arguments and delegates to the canonical
//! `visit.rs` walkers, so the counters share one exhaustive `Stmt`/`Expr` arm
//! list.
//!
